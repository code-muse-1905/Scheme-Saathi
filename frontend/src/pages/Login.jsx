  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        ...
        >
          <h1 className="text-xl font-bold text-navy-950 mb-1 text-center">Welcome back</h1>
          <p className="text-sm text-gray-500 text-center mb-6">Log in to see your matched schemes</p>
